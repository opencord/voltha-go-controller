...
help:
	...
	@echo
	@echo "exe                  : Build the voltha-go-controller and Test voltha binaries."
	@echo "docker               : Build the voltha-go-controller docker image"
	@echo "build                : Build the voltha-go-controller, Test voltha binaries and docker image"
	@echo "clean                : Removes vendor directory and deletes voltha-go-controller, voltha binaries"
	@echo "                     - If this is the first time you are building, choose 'make build' option."
	@echo
	@echo "sca                  : Runs SCA through golint tool"
...
build:	local-protos local-lib-go docker
...
sca:
	#FIXME, for now running golint tool, later support to execute golancli-lint tool.
