...
// func TestSubscriberHandle_AddSubscriberInfo(t *testing.T) {
// 	type args struct {
// 		cntx context.Context
// 		w    http.ResponseWriter
// 		r    *http.Request
...
// 	req, err := http.NewRequest("POST", "/subscriber_device_info/", bytes.NewBuffer(jsonStr))
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// 	req.Header.Set("Content-Type", "application/json")
// 	req1, err1 := http.NewRequest("POST", "/subscriber_device_info/", bytes.NewBuffer(jsonStr1))
// 	if err1 != nil {
// 		t.Fatal(err1)
// 	}
// 	req1.Header.Set("Content-Type", "application/json")
...
// 			// voltpp.VoltApplicationIntr = voltAppIntr
// 			voltAppIntr.EXPECT().AddVnet(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil).Times(1)
// 			voltAppIntr.EXPECT().AddService(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil).Times(1)
// 			sh.AddSubscriberInfo(tt.args.cntx, tt.args.w, tt.args.r)
// 		})
// 	}
// }
