...
func (gh *GroupsHandle) convertGroupsToOnosGroup(GroupsInfo *of.Group) *OnosGroups {
	var groups OnosGroups
	bucket := []Bucket{}
	...
	fmt.Println("group information :", groups)
	return &groups
}
